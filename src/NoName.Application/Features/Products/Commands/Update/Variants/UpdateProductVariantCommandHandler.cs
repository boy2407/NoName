...
{
    public class UpdateProductVariantCommandHandler : IRequestHandler<UpdateProductVariantCommand, ApiResult<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public UpdateProductVariantCommandHandler(IUnitOfWork unitOfWork, ILanguageService languageService)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<ApiResult<bool>> Handle(UpdateProductVariantCommand request, CancellationToken ct)
        {
            try
            {
