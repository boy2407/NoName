...
{
    public class GetProductsPagingQueryHandle : IRequestHandler<GetProductsPagingQuery, PagedResult<ProductViewModel>>
    {
        private readonly IProductRepository _productRepository;
        private readonly IMapper _mapper; 
        private readonly ILanguageService _languageService;
        public GetProductsPagingQueryHandle(IProductRepository productRepository, IMapper mapper, ILanguageService languageService)
        {
