...
{
    public class AdminGetProductByIdQueryHandler : IRequestHandler<AdminGetProductByIdQuery, ProductAdminViewModel>
    {
        ...
        public async Task<ProductAdminViewModel> Handle(AdminGetProductByIdQuery request, CancellationToken ct)
        {
