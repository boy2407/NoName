...
{
    public class UpdateProductHandler : IRequestHandler<UpdateProduct, ApiResult<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILanguageService _languageService;

        public UpdateProductHandler(IUnitOfWork unitOfWork, ILanguageService languageService)
        {
            _unitOfWork = unitOfWork;
            _languageService = languageService;
        }

        public async Task<ApiResult<bool>> Handle(UpdateProduct request, CancellationToken ct)
        {
